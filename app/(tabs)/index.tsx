...
const plants: Plant[] = [
  ...
  { id: 'monstera', name: 'Monstera', waterLevel: 0.72, lightLevel: 0.55, mood: 'warning', warningLabel: 'SOS Eau !' },
  { id: 'succulente', name: 'Succulente', waterLevel: 0.4, lightLevel: 0.35, mood: 'happy' },
];

function ProgressRow({ icon, value, fillColor }: { icon: keyof typeof Ionicons.glyphMap; value: number; fillColor: string }) {
  return (
    <View style={styles.progressRow}>
      <Ionicons name={icon} size={18} color="#4F9F86" />
      <View style={styles.progressTrack}>
        <View style={[styles.progressFill, { width: `${Math.max(8, value * 100)}%`, backgroundColor: fillColor }]} />
      </View>
    </View>
  );
}
      ...
      <Animated.View
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          <View style={styles.headerRow}>
            <Text style={styles.pageTitle}>Mon Jardin Connecte</Text>
